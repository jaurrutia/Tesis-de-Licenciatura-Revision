...
%
% --- JAUA ---
% Puedes unir con el texto anterior mencionando que el probllema de interacción luz materia se puede estudiar el considerar una onda plana (pones la ecuacion de arriba) interactuando con una partuicula de un material descrito por sus indice de refracci+on. Luego mencionas lo de la extinción.
%
...
$$\int_{-1}^{1}e^{ikr\mu}f(\mu)\dd{\mu}\approx \frac{1}{ikr}\left[f(1)e^{ikr}-f(-1)e^{-ikr}\right].$$}% Puedes unir con el texto anterior mencionando que el probllema de interacción luz materia se puede estudiar el considerar una onda plana (pones la ecuacion de arriba) interactuando con una partuicula de un material descrito por sus indice de refracci+on. Luego mencionas lo de la extinción.
...
% --- JAUA ---
% hay que poner que el \Omega es el ángulo sólifo y a qué se refire, sobre todo ahora que es relevante para tus últimas gráficas.
%
