...
\begin{figure}[h!]
	\centering
	\sidesubfloat[First image]{\hspace{-0.5cm}{	\includegraphics[width=7.3cm]{../../Figuras/4-Resultados/FFdistribution431_Esf.pdf}\label{subfig:FF_541_esf}}}\hspace{0.1cm}
	\sidesubfloat[Second image]{\hspace{-0.5cm}{
			\includegraphics[width=8cm]{../../Figuras/4-Resultados/polarplot431FFComEsfEri.pdf}\label{subfig:FF_polar_541_esf}}}\vspace{-0.1cm}
...
\begin{figure}[tb]
	\centering
	\sidesubfloat[First image]{\hspace{-0.5cm}{	\includegraphics[width=7.3cm]{../../Figuras/4-Resultados/FFdistribution431_Esf.pdf}\label{subfig:FF_573_health}}}\hspace{0.1cm}
	\sidesubfloat[Second image]{\hspace{-0.5cm}{
			\includegraphics[width=8cm]{../../Figuras/4-Resultados/polarplot431FFComEsfEri.pdf}\label{subfig:FF_polar_573_health}}}\vspace{-0.1cm}
	\
	\vspace{0.1cm}
